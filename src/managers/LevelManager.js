class LevelManager {
    ...
    #updateButterflyMotion(butterfly) {
        ...
        const toAnchor = p5.Vector.sub(butterfly.anchor, butterfly.position);
    ...
    #createEnemies() {
        ...
        const startBuffer = max(this.settings.generalBuffer, spawn.startBuffer, this.settings.enemy.distRange + spawn.edgePadding);
    ...
    #createButterflies() {
        ...
        const createButterflyOnPlatform = (platform, kind, phaseIndex) => {
            ...
            const velocity = p5.Vector.random2D().mult(random(0.25, 0.65));
