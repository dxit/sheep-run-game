class CharacterManager {
    ...
    setDirection(direction, value, reset = false) {
        ...
        if (!direction || !Object.keys(this.direction).includes(direction)) {
            return;
        }
    ...
    getDirection(direction) {
        if (this.direction[direction] !== undefined) {
            ...
            console.error("getDirection()", "Cannot get the required direction", direction);
        }
    }
    ...
    setState(state, value, reset = false) {
        ...
        if (!state || !Object.keys(this.state).includes(state)) {
            return;
        }
    ...
    getState(state) {
        if (this.state[state] !== undefined) {
            ...
            console.error("getState()", "Cannot get the required state", state);
        }
    }
